...
export default function landigpage(props){
    return(
        <div className='flex flex-wrap justify-center items-center gap-5 sm:gap-14'>
            <button className="  w-72 flex flex-col gap-5 items-center text-center bg-light-gray rounded-md p-7 shadow-md lg:px-40 focus:outline-none focus:scale-105 focus:shadow-lg">
